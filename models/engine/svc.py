...
classes = {'User': User, 'Equipment': Equipment, 'Material': Material, 'MaterialSuppliers': MaterialSuppliers, 'MLocation': MLocation, 'ELocation': ELocation, 'EquipmentSuppliers': EquipmentSuppliers, 'ValSupp': ValidateSupp, 'ValItem': ValidateItem, 'Booking': Booking}
